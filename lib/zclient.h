...
/* @PEMP */
#define ZAPI_MESSAGE_INGRESSCOST   0x10
#define ZAPI_MESSAGE_WEIGHT   	   0x20
...
struct zapi_ipv4
{
  ...
  /*@PEMP an array of weight associated with each next hop - use the same nexthop_num*/
  u_char **weight;
  /*@PEMP community id */
  u_char pemp_community_id;
  /*@PEMP an array of default route flag associated with each next hop */
