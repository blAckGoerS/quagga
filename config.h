...
#define HAVE_BSD_IFI_LINK_STATE /**/

/* BSD link-detect */
#define HAVE_BSD_LINK_DETECT /**/
...
#define ISIS_METHOD ISIS_METHOD_BPF
...
#define PACKAGE_STRING "Quagga 0.99.23"
...
#define PACKAGE_VERSION "0.99.23"
