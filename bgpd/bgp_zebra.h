...
#define BGP_NHWEIGHT_BUF_SIZE (8 * sizeof (u_char *))  //PEMP support
#define BGP_NHFLAG_BUF_SIZE (8 * sizeof (u_char *))  //PEMP support

extern struct stream *bgp_nexthop_buf;
extern struct stream *bgp_nhweight_buf;	//PEMP support  
extern struct stream *bgp_nhfag_buf;	//PEMP support
