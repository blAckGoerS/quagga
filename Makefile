...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = i386-unknown-freebsd10.1
host_triplet = i386-unknown-freebsd10.1
target_triplet = i386-unknown-freebsd10.1
subdir = .
...
ACLOCAL = ${SHELL} /usr/home/sirius/quagga/quagga-0.99.23/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /usr/home/sirius/quagga/quagga-0.99.23/missing autoconf
AUTOHEADER = ${SHELL} /usr/home/sirius/quagga/quagga-0.99.23/missing autoheader
AUTOMAKE = ${SHELL} /usr/home/sirius/quagga/quagga-0.99.23/missing automake-1.14
AWK = gawk
BABELD = babeld
BGPD = bgpd
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/home/sirius/quagga/quagga-0.99.23/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_NAME = Quagga
PACKAGE_STRING = Quagga 0.99.23
PACKAGE_TARNAME = quagga
PACKAGE_URL = 
PACKAGE_VERSION = 0.99.23
PATH_SEPARATOR = :
PDFLATEX = /bin/false
PERL = /usr/bin/perl
PICFLAGS = -fPIE
...
ZEBRA = zebra
abs_builddir = /usr/home/sirius/quagga/quagga-0.99.23
abs_srcdir = /usr/home/sirius/quagga/quagga-0.99.23
abs_top_builddir = /usr/home/sirius/quagga/quagga-0.99.23
abs_top_srcdir = /usr/home/sirius/quagga/quagga-0.99.23
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
build = i386-unknown-freebsd10.1
build_alias = 
build_cpu = i386
build_os = freebsd10.1
...
install_sh = ${SHELL} /usr/home/sirius/quagga/quagga-0.99.23/install-sh
